...
tellraw @s [{"text":""}]
tellraw @s {"text":"Czerwony","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set czer pt.t1 1"}}
tellraw @s {"text":"Niebieski","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set nieb pt.t1 1"}}
tellraw @s {"text":"Zielony","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set ziel pt.t1 1"}}
tellraw @s {"text":"Żółty","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set zolt pt.t1 1"}}
tellraw @s [{"text":""}]

tellraw @s [{"text":""}]
tellraw @s {"text":"Wybierz Drużynę 2:","bold":true,"hoverEvent":{"action":"show_text","contents":[{"text":"Team 2"}]}}
tellraw @s [{"text":""}]
tellraw @s {"text":"Czerwony","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set czer pt.t2 1"}}
tellraw @s {"text":"Niebieski","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set nieb pt.t2 1"}}
tellraw @s {"text":"Zielony","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set ziel pt.t2 1"}}
tellraw @s {"text":"Żółty","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/scoreboard players set zolt pt.t2 1"}}
tellraw @s [{"text":""}]
...
tellraw @s [{"text":""}]
tellraw @s {"text":"Reset matchReady bb.isReady","color":"white","bold":true,"hoverEvent":{"action":"show_text","contents":[{"text":"","bold":true,"italic":true,"underlined":true}]},"clickEvent":{"action":"run_command","value":"/scoreboard players set matchReady bb.isReady 0"}}
